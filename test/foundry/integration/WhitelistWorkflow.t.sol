...
contract WhitelistWorkflowTest is CommonBase {
    ...
    function test_Whitelist_MultipleTargets() public {
        ...
        GuardControllerDefinitions.GuardConfigAction[] memory actions = new GuardControllerDefinitions.GuardConfigAction[](2);
        actions[0] = GuardControllerDefinitions.GuardConfigAction({
            actionType: GuardControllerDefinitions.GuardConfigActionType.ADD_TARGET_TO_WHITELIST,
            data: abi.encode(TEST_FUNCTION_SELECTOR, target1)
        });
        actions[1] = GuardControllerDefinitions.GuardConfigAction({
            actionType: GuardControllerDefinitions.GuardConfigActionType.ADD_TARGET_TO_WHITELIST,
        ...
        assertEq(uint8(decodedActions[1].actionType), uint8(GuardControllerDefinitions.GuardConfigActionType.ADD_TARGET_TO_WHITELIST));
