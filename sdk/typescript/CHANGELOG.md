...
## [1.1.0](https://github.com/PracticalParticle/Bloxchain-Protocol/compare/sdk-v1.0.0...sdk-v1.1.0) (2026-06-03)
...
First **stable** documented release on npm (`latest`). TypeScript SDK for Bloxchain contract interaction (Viem).
