...
Returns predefined function schemas for GuardController execution functions and attached-payment policy keys


**Returns:**
- Array of function schema definitions (12 entries: 9 controller surfaces + 3 payment whitelist selectors)
...
- `` (): If true, &#x60;EngineBlox.unregisterFunction&#x60; reverts when **any role** still lists this selector (not a whitelist-emptiness check; whitelist/hook entries may remain).
