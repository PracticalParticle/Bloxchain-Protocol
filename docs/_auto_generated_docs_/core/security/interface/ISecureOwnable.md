...
```solidity
function updateBroadcasterRequest(address newBroadcaster, address currentBroadcaster) external nonpayable returns (uint256)
```

Requests a broadcaster role change identified by addresses.

**Parameters:**
- `` (): New broadcaster (zero address to revoke &#x60;currentBroadcaster&#x60;)
- `` (): Existing broadcaster to replace or revoke; zero address to add &#x60;newBroadcaster&#x60;
