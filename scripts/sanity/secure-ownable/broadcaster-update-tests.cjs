...
class BroadcasterUpdateTests extends BaseSecureOwnableTest {
    ...
    async testMetaTransactionCancellation() {
        ...
        await this.validateWorkflowPermissions('BROADCASTER UPDATE META-TRANSACTION CANCELLATION', [
            {
                role: 'owner',
                functionSelector: this.FUNCTION_SELECTORS.UPDATE_BROADCASTER_CANCEL_META_SELECTOR, // UPDATE_BROADCASTER_CANCEL_META_SELECTOR
        ...
        try {
            ...
            const metaTxParams = await this.callContractMethod(this.contract.methods.createMetaTxParams(
                ...
                this.FUNCTION_SELECTORS.UPDATE_BROADCASTER_CANCEL_META_SELECTOR, // UPDATE_BROADCASTER_CANCEL_META_SELECTOR
            ...
            // TxStatus enum: 0=UNDEFINED, 1=PENDING, 2=EXECUTING, 3=PROCESSING_PAYMENT, 4=CANCELLED, 5=COMPLETED, 6=FAILED
    ...
    async testMetaTransactionApproval() {
        ...
        await this.validateWorkflowPermissions('BROADCASTER UPDATE META-TRANSACTION APPROVAL', [
            {
                role: 'owner',
                functionSelector: this.FUNCTION_SELECTORS.UPDATE_BROADCASTER_APPROVE_META_SELECTOR, // UPDATE_BROADCASTER_APPROVE_META_SELECTOR
        ...
        try {
            ...
            const metaTxParams = await this.callContractMethod(this.contract.methods.createMetaTxParams(
                this.contractAddress,
                this.FUNCTION_SELECTORS.UPDATE_BROADCASTER_APPROVE_META_SELECTOR, // UPDATE_BROADCASTER_APPROVE_META_SELECTOR
